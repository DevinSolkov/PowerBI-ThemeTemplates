...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    parser.add_argument("--prompt", type=Path, default=Path("5.Prompts/TableMatrixIntegration.xml"))
    ...
    integrated_path = config.outputs.get("Rainwater Theme v4.1.with-table-matrix.json")
    ...
    diff_path = config.outputs.get("table_matrix_integration_diff.json")
    if not diff_path:
    ...
    validation_path = config.outputs.get("table_matrix_integration_validation.md")
